      ...
      <section class="light">
		...
		<article class="postcard light blue">
			<a class="postcard__img_link" href="#">
				<img class="postcard__img" src="images/bank-01.jpg" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">Welcome to Bankist</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt">
           <b>Bankist</b> is a leading digital-first private sector bank in Bangladesh, renowned for its innovation and customer-centric approach. Headquartered in New York, USA, Bankist operates through 16 regional hubs and 57 zonal offices, providing seamless banking experiences across the nation.
</div>
